...
openssl x509 -req -extfile <(printf "subjectAltName=DNS:checkin.example.org") -days 365 -in checkin.csr -CA ../ca/rootCA.crt -CAkey ../ca/rootCA.key -CAcreateserial -out src/cert.pem    
